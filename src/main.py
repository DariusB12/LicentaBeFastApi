...
from src.routers import auth_router, social_accounts_router, yolo_detection_router, translate_router, \
    social_accounts_posts_router, user_router, photos_router, analysis_router
from fastapi import FastAPI, Request, HTTPException
from fastapi.responses import JSONResponse
from fastapi.middleware.cors import CORSMiddleware

from src.websocket.websocket_connection import websocket_endpoint
