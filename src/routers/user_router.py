...
from src.app_responses.user_responses.social_accounts_response import SocialAccountsResponse
...
from src.service.user_service import get_user_social_account
