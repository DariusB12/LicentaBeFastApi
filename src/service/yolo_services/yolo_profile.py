...
from src.service.utils.yolo_utils import languages_list_to_tesseract_lang
from src.service.utils.lang_utils import normalize_text, COMMON_LANGUAGES, predict_text_language_fasttext_lid218, \
