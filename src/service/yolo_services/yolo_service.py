...
from src.service.yolo_services.yolo_posts import extract_post_data, detect_comments_text_with_specified_language, \
    parse_posts_date
from src.service.yolo_services.yolo_profile import extract_profile_data, detect_description_text_with_specified_language
from src.service.utils.yolo_utils import base64_to_cv2_img, parse_number, cv2_img_to_base64
